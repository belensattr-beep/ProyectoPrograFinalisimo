...
ModoKiosko::ModoKiosko(PantallaLCD& l, Buzzer& b, Reloj& r, AlmacenSD& s, LectorNFC& n, Teclado& t)
  : lcd(l), buzzer(b), reloj(r), sd(s), nfc(n), teclado(t), 
    estado(ESPERANDO_MONTO), monto(0), tipo('0'), tMensaje(0) {}
